        ...
        <div class="row">
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <div class="testimony-39291">
              <blockquote>
                <p>This is legit the best platform for my carreer! i highly recommend people that are in to the media or youtube to get a profile here!</p>
              </blockquote>
              <div class="d-flex vcard align-items-center">
                <div class="pic mr-3">
                </div>
                <div class="text">
                  <strong class="d-block">Danny Milosevic </strong>
                  <span>Youtuber Danny bruv</span>
                </div>
              </div>
            </div>
          </div>
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <div class="testimony-39291">
              <blockquote>
<p>We gained alot of project throug this platform, i give it a nice 5 star rating!
</p>
              </blockquote>
              <div class="d-flex vcard align-items-center">
                <div class="pic mr-3">
                ...
                <div class="text">
                  <strong class="d-block">Andjela</strong>
                  <span>CEO DFAM Digital Agency</span>
                </div>
              </div>
            </div>
          </div>
          <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
            <div class="testimony-39291">
              <blockquote>
<p>Very nice and easy platform, and also great prices!
</p>              </blockquote>
              <div class="d-flex vcard align-items-center">
                <div class="pic mr-3">
                </div>
                <div class="text">
                  <strong class="d-block">Berk houder</strong>
                  <span>Designer</span>
                </div>
              </div>
            </div>
...
background: radial-gradient(circle, rgba(63,94,251,1) 0%, rgba(0,191,255,1) 98%) !important;
        }
...
@keyframes anim1 {
  0% {
    opacity: 1;
    transform: rotate(240deg) translate3d(169px, 810px, 1000px) scale(1);
  }
}
.tri:nth-child(2) {
  border-top: 2px solid #73ff00;
...
@keyframes anim2 {
  0% {
    opacity: 1;
    transform: rotate(478.5deg) translate3d(865px, 858px, 1000px) scale(1);
  }
}
.tri:nth-child(3) {
  border-top: 12px solid #ff4400;
...
@keyframes anim3 {
  0% {
    opacity: 1;
    transform: rotate(156deg) translate3d(367px, 359px, 1000px) scale(1);
  }
}
.tri:nth-child(4) {
  border-top: 8px solid #00ff80;
...
@keyframes anim4 {
  0% {
    opacity: 1;
    transform: rotate(172.5deg) translate3d(619px, 566px, 1000px) scale(1);
  }
}
.tri:nth-child(5) {
  border-top: 37px solid #3c00ff;
...
@keyframes anim5 {
  0% {
    opacity: 1;
    transform: rotate(40.5deg) translate3d(131px, 758px, 1000px) scale(1);
  }
}
.tri:nth-child(6) {
  border-top: 25px solid #ff005e;
...
@keyframes anim6 {
  0% {
    opacity: 1;
    transform: rotate(256.5deg) translate3d(241px, 2px, 1000px) scale(1);
  }
}
.tri:nth-child(7) {
  border-top: 19px solid #ff0066;
...
@keyframes anim7 {
  0% {
    opacity: 1;
    transform: rotate(271.5deg) translate3d(399px, 181px, 1000px) scale(1);
  }
}
.tri:nth-child(8) {
  border-top: 48px solid #ff0400;
...
@keyframes anim8 {
  0% {
    opacity: 1;
    transform: rotate(150deg) translate3d(120px, 842px, 1000px) scale(1);
  }
}
.tri:nth-child(9) {
  border-top: 19px solid #ff00b7;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim9 {
  0% {
    opacity: 1;
    transform: rotate(106.5deg) translate3d(883px, 669px, 1000px) scale(1);
  }
}
.tri:nth-child(10) {
  border-top: 8px solid #00ff1e;
  border-right: 8px solid transparent;
  border-left: 8px solid transparent;
  margin-left: -4px;
  margin-top: -4px;
...
@keyframes anim10 {
  0% {
    opacity: 1;
    transform: rotate(423deg) translate3d(951px, 427px, 1000px) scale(1);
  }
}
.tri:nth-child(11) {
  border-top: 11px solid #00ff5e;
...
@keyframes anim11 {
  0% {
    opacity: 1;
    transform: rotate(406.5deg) translate3d(707px, 431px, 1000px) scale(1);
  }
}
.tri:nth-child(12) {
  ...
  -webkit-filter: grayscale(1);
  filter: grayscale(1);
  transform: rotate(18deg) translate3d(0, 0, -1500px) scale(0);
...
@keyframes anim12 {
  0% {
    opacity: 1;
    transform: rotate(27deg) translate3d(572px, 420px, 1000px) scale(1);
  }
}
.tri:nth-child(13) {
  border-top: 27px solid #ff00f2;
...
@keyframes anim13 {
  0% {
    opacity: 1;
    transform: rotate(139.5deg) translate3d(340px, 202px, 1000px) scale(1);
  }
}
.tri:nth-child(14) {
...
@keyframes anim14 {
  0% {
    opacity: 1;
    transform: rotate(276deg) translate3d(501px, 274px, 1000px) scale(1);
  }
}
.tri:nth-child(15) {
  border-top: 36px solid #59ff00;
...
@keyframes anim15 {
  0% {
    opacity: 1;
    transform: rotate(282deg) translate3d(619px, 210px, 1000px) scale(1);
  }
}
.tri:nth-child(16) {
...
@keyframes anim16 {
  0% {
    opacity: 1;
    transform: rotate(349.5deg) translate3d(986px, 488px, 1000px) scale(1);
  }
}
.tri:nth-child(17) {
  border-top: 6px solid #59ff00;
...
@keyframes anim17 {
  0% {
    opacity: 1;
    transform: rotate(501deg) translate3d(731px, 642px, 1000px) scale(1);
  }
}
.tri:nth-child(18) {
  border-top: 48px solid #0040ff;
  border-right: 48px solid transparent;
  border-left: 48px solid transparent;
  margin-left: -24px;
  margin-top: -24px;
...
@keyframes anim18 {
  0% {
    opacity: 1;
    transform: rotate(318deg) translate3d(204px, 257px, 1000px) scale(1);
  }
}
.tri:nth-child(19) {
  border-top: 46px solid #ff00f7;
...
@keyframes anim19 {
  0% {
    opacity: 1;
    transform: rotate(106.5deg) translate3d(816px, 150px, 1000px) scale(1);
  }
}
.tri:nth-child(20) {
...
@keyframes anim20 {
  0% {
    opacity: 1;
    transform: rotate(427.5deg) translate3d(475px, 323px, 1000px) scale(1);
  }
}
.tri:nth-child(21) {
  border-top: 7px solid #f2ff00;
  border-right: 7px solid transparent;
  border-left: 7px solid transparent;
  margin-left: -3.5px;
  margin-top: -3.5px;
...
@keyframes anim21 {
  0% {
    opacity: 1;
    transform: rotate(519deg) translate3d(202px, 795px, 1000px) scale(1);
  }
}
.tri:nth-child(22) {
  border-top: 42px solid #ff00cc;
...
@keyframes anim22 {
  0% {
    opacity: 1;
    transform: rotate(523.5deg) translate3d(441px, 972px, 1000px) scale(1);
  }
}
.tri:nth-child(23) {
...
@keyframes anim23 {
  0% {
    opacity: 1;
    transform: rotate(31.5deg) translate3d(233px, 292px, 1000px) scale(1);
  }
}
.tri:nth-child(24) {
  border-top: 41px solid #e6ff00;
...
@keyframes anim24 {
  0% {
    opacity: 1;
    transform: rotate(105deg) translate3d(35px, 356px, 1000px) scale(1);
  }
}
.tri:nth-child(25) {
...
@keyframes anim25 {
  0% {
    opacity: 1;
    transform: rotate(519deg) translate3d(306px, 527px, 1000px) scale(1);
  }
}
.tri:nth-child(26) {
  border-top: 19px solid #4dff00;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim26 {
  0% {
    opacity: 1;
    transform: rotate(27deg) translate3d(610px, 64px, 1000px) scale(1);
  }
}
.tri:nth-child(27) {
  border-top: 21px solid #00ffbf;
...
@keyframes anim27 {
  0% {
    opacity: 1;
    transform: rotate(504deg) translate3d(752px, 573px, 1000px) scale(1);
  }
}
.tri:nth-child(28) {
  border-top: 44px solid #009dff;
...
@keyframes anim28 {
  0% {
    opacity: 1;
    transform: rotate(222deg) translate3d(816px, 280px, 1000px) scale(1);
  }
}
.tri:nth-child(29) {
  border-top: 43px solid #91ff00;
  border-right: 43px solid transparent;
  border-left: 43px solid transparent;
  margin-left: -21.5px;
  margin-top: -21.5px;
...
@keyframes anim29 {
  0% {
    opacity: 1;
    transform: rotate(147deg) translate3d(56px, 222px, 1000px) scale(1);
  }
}
.tri:nth-child(30) {
  border-top: 48px solid #ff008c;
  border-right: 48px solid transparent;
  border-left: 48px solid transparent;
  margin-left: -24px;
  margin-top: -24px;
...
@keyframes anim30 {
  0% {
    opacity: 1;
    transform: rotate(450deg) translate3d(153px, 614px, 1000px) scale(1);
  }
}
.tri:nth-child(31) {
...
@keyframes anim31 {
  0% {
    opacity: 1;
    transform: rotate(330deg) translate3d(717px, 167px, 1000px) scale(1);
  }
}
.tri:nth-child(32) {
  border-top: 33px solid #2f00ff;
...
@keyframes anim32 {
  0% {
    opacity: 1;
    transform: rotate(13.5deg) translate3d(335px, 663px, 1000px) scale(1);
  }
}
.tri:nth-child(33) {
  border-top: 45px solid #ff002f;
  ...
  -webkit-filter: grayscale(1);
  filter: grayscale(1);
  transform: rotate(259deg) translate3d(0, 0, -1500px) scale(0);
...
@keyframes anim33 {
  0% {
    opacity: 1;
    transform: rotate(388.5deg) translate3d(680px, 878px, 1000px) scale(1);
  }
}
.tri:nth-child(34) {
  border-top: 38px solid #88ff00;
...
@keyframes anim34 {
  0% {
    opacity: 1;
    transform: rotate(202.5deg) translate3d(613px, 804px, 1000px) scale(1);
  }
}
.tri:nth-child(35) {
...
@keyframes anim35 {
  0% {
    opacity: 1;
    transform: rotate(57deg) translate3d(521px, 673px, 1000px) scale(1);
  }
}
.tri:nth-child(36) {
  border-top: 9px solid #d900ff;
...
@keyframes anim36 {
  0% {
    opacity: 1;
    transform: rotate(403.5deg) translate3d(27px, 488px, 1000px) scale(1);
  }
}
.tri:nth-child(37) {
  border-top: 47px solid #ff0022;
...
@keyframes anim37 {
  0% {
    opacity: 1;
    transform: rotate(282deg) translate3d(156px, 827px, 1000px) scale(1);
  }
}
.tri:nth-child(38) {
  border-top: 8px solid #2b00ff;
  border-right: 8px solid transparent;
  border-left: 8px solid transparent;
  margin-left: -4px;
  margin-top: -4px;
...
@keyframes anim38 {
  0% {
    opacity: 1;
    transform: rotate(51deg) translate3d(218px, 482px, 1000px) scale(1);
  }
}
.tri:nth-child(39) {
  border-top: 14px solid #4000ff;
...
@keyframes anim39 {
  0% {
    opacity: 1;
    transform: rotate(478.5deg) translate3d(298px, 331px, 1000px) scale(1);
  }
}
.tri:nth-child(40) {
  border-top: 35px solid #1eff00;
...
@keyframes anim40 {
  0% {
    opacity: 1;
    transform: rotate(382.5deg) translate3d(762px, 992px, 1000px) scale(1);
  }
}
.tri:nth-child(41) {
  border-top: 13px solid #40ff00;
...
@keyframes anim41 {
  0% {
    opacity: 1;
    transform: rotate(409.5deg) translate3d(364px, 136px, 1000px) scale(1);
  }
}
.tri:nth-child(42) {
  border-top: 35px solid #ffee00;
  border-right: 35px solid transparent;
  border-left: 35px solid transparent;
  margin-left: -17.5px;
  margin-top: -17.5px;
...
@keyframes anim42 {
  0% {
    opacity: 1;
    transform: rotate(214.5deg) translate3d(774px, 747px, 1000px) scale(1);
  }
}
.tri:nth-child(43) {
  border-top: 39px solid #00ffd0;
...
@keyframes anim43 {
  0% {
    opacity: 1;
    transform: rotate(138deg) translate3d(646px, 882px, 1000px) scale(1);
  }
}
.tri:nth-child(44) {
  border-top: 5px solid #a6ff00;
  border-right: 5px solid transparent;
  border-left: 5px solid transparent;
  margin-left: -2.5px;
  margin-top: -2.5px;
...
@keyframes anim44 {
  0% {
    opacity: 1;
    transform: rotate(199.5deg) translate3d(638px, 139px, 1000px) scale(1);
  }
}
.tri:nth-child(45) {
...
@keyframes anim45 {
  0% {
    opacity: 1;
    transform: rotate(37.5deg) translate3d(368px, 243px, 1000px) scale(1);
  }
}
.tri:nth-child(46) {
  border-top: 9px solid #d5ff00;
  border-right: 9px solid transparent;
  border-left: 9px solid transparent;
  margin-left: -4.5px;
  margin-top: -4.5px;
...
@keyframes anim46 {
  0% {
    opacity: 1;
    transform: rotate(414deg) translate3d(548px, 334px, 1000px) scale(1);
  }
}
.tri:nth-child(47) {
  border-top: 6px solid #00ff37;
  border-right: 6px solid transparent;
  border-left: 6px solid transparent;
  margin-left: -3px;
  margin-top: -3px;
...
@keyframes anim47 {
  0% {
    opacity: 1;
    transform: rotate(145.5deg) translate3d(428px, 130px, 1000px) scale(1);
  }
}
.tri:nth-child(48) {
  border-top: 42px solid #ff0066;
  border-right: 42px solid transparent;
  border-left: 42px solid transparent;
  margin-left: -21px;
  margin-top: -21px;
...
@keyframes anim48 {
  0% {
    opacity: 1;
    transform: rotate(79.5deg) translate3d(625px, 693px, 1000px) scale(1);
  }
}
.tri:nth-child(49) {
  border-top: 25px solid #ff0040;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim49 {
  0% {
    opacity: 1;
    transform: rotate(459deg) translate3d(851px, 680px, 1000px) scale(1);
  }
}
.tri:nth-child(50) {
...
@keyframes anim50 {
  0% {
    opacity: 1;
    transform: rotate(28.5deg) translate3d(901px, 158px, 1000px) scale(1);
  }
}
.tri:nth-child(51) {
  border-top: 35px solid #1500ff;
  border-right: 35px solid transparent;
  border-left: 35px solid transparent;
  margin-left: -17.5px;
  margin-top: -17.5px;
...
@keyframes anim51 {
  0% {
    opacity: 1;
    transform: rotate(102deg) translate3d(289px, 887px, 1000px) scale(1);
  }
}
.tri:nth-child(52) {
  border-top: 42px solid #00ff48;
  border-right: 42px solid transparent;
  border-left: 42px solid transparent;
  margin-left: -21px;
  margin-top: -21px;
...
@keyframes anim52 {
  0% {
    opacity: 1;
    transform: rotate(217.5deg) translate3d(318px, 156px, 1000px) scale(1);
  }
}
.tri:nth-child(53) {
...
@keyframes anim53 {
  0% {
    opacity: 1;
    transform: rotate(142.5deg) translate3d(844px, 376px, 1000px) scale(1);
  }
}
.tri:nth-child(54) {
...
@keyframes anim54 {
  0% {
    opacity: 1;
    transform: rotate(378deg) translate3d(668px, 726px, 1000px) scale(1);
  }
}
.tri:nth-child(55) {
  border-top: 17px solid #9100ff;
...
@keyframes anim55 {
  0% {
    opacity: 1;
    transform: rotate(303deg) translate3d(833px, 177px, 1000px) scale(1);
  }
}
.tri:nth-child(56) {
...
@keyframes anim56 {
  0% {
    opacity: 1;
    transform: rotate(135deg) translate3d(385px, 301px, 1000px) scale(1);
  }
}
.tri:nth-child(57) {
...
@keyframes anim57 {
  0% {
    opacity: 1;
    transform: rotate(1.5deg) translate3d(962px, 699px, 1000px) scale(1);
  }
}
.tri:nth-child(58) {
  border-top: 47px solid #00ff9d;
  border-right: 47px solid transparent;
  border-left: 47px solid transparent;
  margin-left: -23.5px;
  margin-top: -23.5px;
...
@keyframes anim58 {
  0% {
    opacity: 1;
    transform: rotate(295.5deg) translate3d(482px, 600px, 1000px) scale(1);
  }
}
.tri:nth-child(59) {
  border-top: 25px solid #00ffbf;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim59 {
  0% {
    opacity: 1;
    transform: rotate(453deg) translate3d(232px, 916px, 1000px) scale(1);
  }
}
.tri:nth-child(60) {
  ...
  -webkit-filter: grayscale(1);
  filter: grayscale(1);
  transform: rotate(190deg) translate3d(0, 0, -1500px) scale(0);
...
@keyframes anim60 {
  0% {
    opacity: 1;
    transform: rotate(285deg) translate3d(869px, 913px, 1000px) scale(1);
  }
}
.tri:nth-child(61) {
...
@keyframes anim61 {
  0% {
    opacity: 1;
    transform: rotate(382.5deg) translate3d(981px, 673px, 1000px) scale(1);
  }
}
.tri:nth-child(62) {
  border-top: 39px solid #3cff00;
  border-right: 39px solid transparent;
  border-left: 39px solid transparent;
  margin-left: -19.5px;
  margin-top: -19.5px;
...
@keyframes anim62 {
  0% {
    opacity: 1;
    transform: rotate(315deg) translate3d(507px, 360px, 1000px) scale(1);
  }
}
.tri:nth-child(63) {
  border-top: 7px solid #00ff2b;
  border-right: 7px solid transparent;
  border-left: 7px solid transparent;
  margin-left: -3.5px;
  margin-top: -3.5px;
...
@keyframes anim63 {
  0% {
    opacity: 1;
    transform: rotate(189deg) translate3d(932px, 655px, 1000px) scale(1);
  }
}
.tri:nth-child(64) {
...
@keyframes anim64 {
  0% {
    opacity: 1;
    transform: rotate(52.5deg) translate3d(420px, 310px, 1000px) scale(1);
  }
}
.tri:nth-child(65) {
...
@keyframes anim65 {
  0% {
    opacity: 1;
    transform: rotate(81deg) translate3d(73px, 926px, 1000px) scale(1);
  }
}
.tri:nth-child(66) {
...
@keyframes anim66 {
  0% {
    opacity: 1;
    transform: rotate(228deg) translate3d(469px, 612px, 1000px) scale(1);
  }
}
.tri:nth-child(67) {
  border-top: 13px solid #ff6f00;
  border-right: 13px solid transparent;
  border-left: 13px solid transparent;
  margin-left: -6.5px;
  margin-top: -6.5px;
...
@keyframes anim67 {
  0% {
    opacity: 1;
    transform: rotate(264deg) translate3d(494px, 809px, 1000px) scale(1);
  }
}
.tri:nth-child(68) {
  border-top: 14px solid #ffa600;
  border-right: 14px solid transparent;
  border-left: 14px solid transparent;
  margin-left: -7px;
  margin-top: -7px;
...
@keyframes anim68 {
  0% {
    opacity: 1;
    transform: rotate(172.5deg) translate3d(628px, 567px, 1000px) scale(1);
  }
}
.tri:nth-child(69) {
  border-top: 39px solid #d9ff00;
  border-right: 39px solid transparent;
  border-left: 39px solid transparent;
  margin-left: -19.5px;
  margin-top: -19.5px;
...
@keyframes anim69 {
  0% {
    opacity: 1;
    transform: rotate(108deg) translate3d(461px, 39px, 1000px) scale(1);
  }
}
.tri:nth-child(70) {
  border-top: 26px solid #bb00ff;
...
@keyframes anim70 {
  0% {
    opacity: 1;
    transform: rotate(63deg) translate3d(823px, 32px, 1000px) scale(1);
  }
}
.tri:nth-child(71) {
  border-top: 45px solid #8000ff;
  border-right: 45px solid transparent;
  border-left: 45px solid transparent;
  margin-left: -22.5px;
  margin-top: -22.5px;
...
@keyframes anim71 {
  0% {
    opacity: 1;
    transform: rotate(315deg) translate3d(767px, 883px, 1000px) scale(1);
  }
}
.tri:nth-child(72) {
  border-top: 49px solid #ffee00;
...
@keyframes anim72 {
  0% {
    opacity: 1;
    transform: rotate(379.5deg) translate3d(275px, 914px, 1000px) scale(1);
  }
}
.tri:nth-child(73) {
  border-top: 47px solid #aaff00;
  border-right: 47px solid transparent;
  border-left: 47px solid transparent;
  margin-left: -23.5px;
  margin-top: -23.5px;
...
@keyframes anim73 {
  0% {
    opacity: 1;
    transform: rotate(528deg) translate3d(438px, 29px, 1000px) scale(1);
  }
}
.tri:nth-child(74) {
  border-top: 27px solid #ff00ee;
  border-right: 27px solid transparent;
  border-left: 27px solid transparent;
  margin-left: -13.5px;
  margin-top: -13.5px;
...
@keyframes anim74 {
  0% {
    opacity: 1;
    transform: rotate(403.5deg) translate3d(357px, 1000px, 1000px) scale(1);
  }
}
.tri:nth-child(75) {
  border-top: 16px solid #a6ff00;
  border-right: 16px solid transparent;
  border-left: 16px solid transparent;
  margin-left: -8px;
  margin-top: -8px;
...
@keyframes anim75 {
  0% {
    opacity: 1;
    transform: rotate(382.5deg) translate3d(140px, 567px, 1000px) scale(1);
  }
}
.tri:nth-child(76) {
  border-top: 41px solid #00bbff;
  border-right: 41px solid transparent;
  border-left: 41px solid transparent;
  margin-left: -20.5px;
  margin-top: -20.5px;
...
@keyframes anim76 {
  0% {
    opacity: 1;
    transform: rotate(205.5deg) translate3d(507px, 578px, 1000px) scale(1);
  }
}
.tri:nth-child(77) {
  border-top: 40px solid #00ccff;
...
@keyframes anim77 {
  0% {
    opacity: 1;
    transform: rotate(228deg) translate3d(322px, 719px, 1000px) scale(1);
  }
}
.tri:nth-child(78) {
  border-top: 50px solid #00ff4d;
  border-right: 50px solid transparent;
  border-left: 50px solid transparent;
  margin-left: -25px;
  margin-top: -25px;
...
@keyframes anim78 {
  0% {
    opacity: 1;
    transform: rotate(292.5deg) translate3d(416px, 957px, 1000px) scale(1);
  }
}
.tri:nth-child(79) {
  border-top: 22px solid #ff4000;
...
@keyframes anim79 {
  0% {
    opacity: 1;
    transform: rotate(55.5deg) translate3d(946px, 577px, 1000px) scale(1);
  }
}
.tri:nth-child(80) {
  border-top: 35px solid #00ff55;
  border-right: 35px solid transparent;
  border-left: 35px solid transparent;
  margin-left: -17.5px;
  margin-top: -17.5px;
...
@keyframes anim80 {
  0% {
    opacity: 1;
    transform: rotate(177deg) translate3d(45px, 457px, 1000px) scale(1);
  }
}
.tri:nth-child(81) {
...
@keyframes anim81 {
  0% {
    opacity: 1;
    transform: rotate(189deg) translate3d(914px, 88px, 1000px) scale(1);
  }
}
.tri:nth-child(82) {
  border-top: 46px solid #ffc800;
  border-right: 46px solid transparent;
  border-left: 46px solid transparent;
  margin-left: -23px;
  margin-top: -23px;
...
@keyframes anim82 {
  0% {
    opacity: 1;
    transform: rotate(21deg) translate3d(341px, 443px, 1000px) scale(1);
  }
}
.tri:nth-child(83) {
...
@keyframes anim83 {
  0% {
    opacity: 1;
    transform: rotate(502.5deg) translate3d(544px, 172px, 1000px) scale(1);
  }
}
.tri:nth-child(84) {
  border-top: 25px solid #00d5ff;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim84 {
  0% {
    opacity: 1;
    transform: rotate(312deg) translate3d(111px, 462px, 1000px) scale(1);
  }
}
.tri:nth-child(85) {
  border-top: 25px solid #ff2600;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim85 {
  0% {
    opacity: 1;
    transform: rotate(409.5deg) translate3d(487px, 167px, 1000px) scale(1);
  }
}
.tri:nth-child(86) {
  border-top: 48px solid #c400ff;
  border-right: 48px solid transparent;
  border-left: 48px solid transparent;
  margin-left: -24px;
  margin-top: -24px;
...
@keyframes anim86 {
  0% {
    opacity: 1;
    transform: rotate(517.5deg) translate3d(110px, 891px, 1000px) scale(1);
  }
}
.tri:nth-child(87) {
  border-top: 17px solid #ff3300;
  border-right: 17px solid transparent;
  border-left: 17px solid transparent;
  margin-left: -8.5px;
  margin-top: -8.5px;
...
@keyframes anim87 {
  0% {
    opacity: 1;
    transform: rotate(334.5deg) translate3d(632px, 991px, 1000px) scale(1);
  }
}
.tri:nth-child(88) {
  border-top: 41px solid #ff3300;
  border-right: 41px solid transparent;
  border-left: 41px solid transparent;
  margin-left: -20.5px;
  margin-top: -20.5px;
...
@keyframes anim88 {
  0% {
    opacity: 1;
    transform: rotate(360deg) translate3d(611px, 133px, 1000px) scale(1);
  }
}
.tri:nth-child(89) {
  border-top: 22px solid #c8ff00;
  border-right: 22px solid transparent;
  border-left: 22px solid transparent;
  margin-left: -11px;
  margin-top: -11px;
  -webkit-filter: grayscale(1);
  filter: grayscale(1);
  transform: rotate(73deg) translate3d(0, 0, -1500px) scale(0);
...
@keyframes anim89 {
  0% {
    opacity: 1;
    transform: rotate(109.5deg) translate3d(611px, 467px, 1000px) scale(1);
  }
}
.tri:nth-child(90) {
  border-top: 38px solid #ff8800;
  border-right: 38px solid transparent;
  border-left: 38px solid transparent;
  margin-left: -19px;
  margin-top: -19px;
...
@keyframes anim90 {
  0% {
    opacity: 1;
    transform: rotate(246deg) translate3d(440px, 871px, 1000px) scale(1);
  }
}
.tri:nth-child(91) {
  border-top: 24px solid #ff0004;
...
@keyframes anim91 {
  0% {
    opacity: 1;
    transform: rotate(348deg) translate3d(494px, 191px, 1000px) scale(1);
  }
}
.tri:nth-child(92) {
  border-top: 8px solid #d000ff;
  border-right: 8px solid transparent;
  border-left: 8px solid transparent;
  margin-left: -4px;
  margin-top: -4px;
...
@keyframes anim92 {
  0% {
    opacity: 1;
    transform: rotate(472.5deg) translate3d(348px, 764px, 1000px) scale(1);
  }
}
.tri:nth-child(93) {
  border-top: 26px solid #6aff00;
  border-right: 26px solid transparent;
  border-left: 26px solid transparent;
  margin-left: -13px;
  margin-top: -13px;
...
@keyframes anim93 {
  0% {
    opacity: 1;
    transform: rotate(222deg) translate3d(526px, 886px, 1000px) scale(1);
  }
}
.tri:nth-child(94) {
  border-top: 40px solid #8c00ff;
  border-right: 40px solid transparent;
  border-left: 40px solid transparent;
  margin-left: -20px;
  margin-top: -20px;
...
@keyframes anim94 {
  0% {
    opacity: 1;
    transform: rotate(177deg) translate3d(873px, 940px, 1000px) scale(1);
  }
}
.tri:nth-child(95) {
  border-top: 26px solid #ff3300;
  border-right: 26px solid transparent;
  border-left: 26px solid transparent;
  margin-left: -13px;
  margin-top: -13px;
...
@keyframes anim95 {
  0% {
    opacity: 1;
    transform: rotate(85.5deg) translate3d(462px, 286px, 1000px) scale(1);
  }
}
.tri:nth-child(96) {
  border-top: 12px solid #ff00aa;
  border-right: 12px solid transparent;
  border-left: 12px solid transparent;
  margin-left: -6px;
  margin-top: -6px;
...
@keyframes anim96 {
  0% {
    opacity: 1;
    transform: rotate(208.5deg) translate3d(935px, 560px, 1000px) scale(1);
  }
}
.tri:nth-child(97) {
  border-top: 25px solid #ff00e6;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim97 {
  0% {
    opacity: 1;
    transform: rotate(471deg) translate3d(351px, 20px, 1000px) scale(1);
  }
}
.tri:nth-child(98) {
  border-top: 19px solid #2fff00;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim98 {
  0% {
    opacity: 1;
    transform: rotate(84deg) translate3d(626px, 411px, 1000px) scale(1);
  }
}
.tri:nth-child(99) {
...
@keyframes anim99 {
  0% {
    opacity: 1;
    transform: rotate(483deg) translate3d(271px, 435px, 1000px) scale(1);
  }
}
.tri:nth-child(100) {
...
@keyframes anim100 {
  0% {
    opacity: 1;
    transform: rotate(297deg) translate3d(588px, 478px, 1000px) scale(1);
  }
}
.tri:nth-child(101) {
  border-top: 41px solid #0022ff;
  border-right: 41px solid transparent;
  border-left: 41px solid transparent;
  margin-left: -20.5px;
  margin-top: -20.5px;
...
@keyframes anim101 {
  0% {
    opacity: 1;
    transform: rotate(201deg) translate3d(466px, 240px, 1000px) scale(1);
  }
}
.tri:nth-child(102) {
  border-top: 47px solid #002fff;
  border-right: 47px solid transparent;
  border-left: 47px solid transparent;
  margin-left: -23.5px;
  margin-top: -23.5px;
...
@keyframes anim102 {
  0% {
    opacity: 1;
    transform: rotate(520.5deg) translate3d(463px, 425px, 1000px) scale(1);
  }
}
.tri:nth-child(103) {
  border-top: 34px solid #95ff00;
  border-right: 34px solid transparent;
  border-left: 34px solid transparent;
  margin-left: -17px;
  margin-top: -17px;
...
@keyframes anim103 {
  0% {
    opacity: 1;
    transform: rotate(22.5deg) translate3d(604px, 207px, 1000px) scale(1);
  }
}
.tri:nth-child(104) {
  border-top: 37px solid #5900ff;
  border-right: 37px solid transparent;
  border-left: 37px solid transparent;
  margin-left: -18.5px;
  margin-top: -18.5px;
...
@keyframes anim104 {
  0% {
    opacity: 1;
    transform: rotate(502.5deg) translate3d(902px, 909px, 1000px) scale(1);
  }
}
.tri:nth-child(105) {
  border-top: 33px solid #ff00aa;
  border-right: 33px solid transparent;
  border-left: 33px solid transparent;
  margin-left: -16.5px;
  margin-top: -16.5px;
...
@keyframes anim105 {
  0% {
    opacity: 1;
    transform: rotate(493.5deg) translate3d(661px, 710px, 1000px) scale(1);
  }
}
.tri:nth-child(106) {
...
@keyframes anim106 {
  0% {
    opacity: 1;
    transform: rotate(472.5deg) translate3d(588px, 67px, 1000px) scale(1);
  }
}
.tri:nth-child(107) {
...
@keyframes anim107 {
  0% {
    opacity: 1;
    transform: rotate(130.5deg) translate3d(610px, 646px, 1000px) scale(1);
  }
}
.tri:nth-child(108) {
  border-top: 20px solid #1e00ff;
...
@keyframes anim108 {
  0% {
    opacity: 1;
    transform: rotate(499.5deg) translate3d(868px, 428px, 1000px) scale(1);
  }
}
.tri:nth-child(109) {
  border-top: 36px solid #00ff9d;
  border-right: 36px solid transparent;
  border-left: 36px solid transparent;
  margin-left: -18px;
  margin-top: -18px;
...
@keyframes anim109 {
  0% {
    opacity: 1;
    transform: rotate(327deg) translate3d(400px, 596px, 1000px) scale(1);
  }
}
.tri:nth-child(110) {
  border-top: 19px solid #ff00f7;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim110 {
  0% {
    opacity: 1;
    transform: rotate(69deg) translate3d(52px, 747px, 1000px) scale(1);
  }
}
.tri:nth-child(111) {
  border-top: 11px solid #ff00a2;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim111 {
  0% {
    opacity: 1;
    transform: rotate(99deg) translate3d(650px, 336px, 1000px) scale(1);
  }
}
.tri:nth-child(112) {
...
@keyframes anim112 {
  0% {
    opacity: 1;
    transform: rotate(480deg) translate3d(838px, 80px, 1000px) scale(1);
  }
}
.tri:nth-child(113) {
  border-top: 19px solid #dd00ff;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim113 {
  0% {
    opacity: 1;
    transform: rotate(528deg) translate3d(452px, 590px, 1000px) scale(1);
  }
}
.tri:nth-child(114) {
  border-top: 24px solid #0091ff;
  border-right: 24px solid transparent;
  border-left: 24px solid transparent;
  margin-left: -12px;
  margin-top: -12px;
...
@keyframes anim114 {
  0% {
    opacity: 1;
    transform: rotate(231deg) translate3d(295px, 414px, 1000px) scale(1);
  }
}
.tri:nth-child(115) {
  border-top: 38px solid #9900ff;
  border-right: 38px solid transparent;
  border-left: 38px solid transparent;
  margin-left: -19px;
  margin-top: -19px;
...
@keyframes anim115 {
  0% {
    opacity: 1;
    transform: rotate(291deg) translate3d(388px, 282px, 1000px) scale(1);
  }
}
.tri:nth-child(116) {
  border-top: 36px solid #00ff3c;
  border-right: 36px solid transparent;
  border-left: 36px solid transparent;
  margin-left: -18px;
  margin-top: -18px;
...
@keyframes anim116 {
  0% {
    opacity: 1;
    transform: rotate(475.5deg) translate3d(929px, 727px, 1000px) scale(1);
  }
}
.tri:nth-child(117) {
  border-top: 7px solid #000dff;
  border-right: 7px solid transparent;
  border-left: 7px solid transparent;
  margin-left: -3.5px;
  margin-top: -3.5px;
...
@keyframes anim117 {
  0% {
    opacity: 1;
    transform: rotate(304.5deg) translate3d(88px, 81px, 1000px) scale(1);
  }
}
.tri:nth-child(118) {
  border-top: 25px solid #ff0062;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim118 {
  0% {
    opacity: 1;
    transform: rotate(64.5deg) translate3d(12px, 661px, 1000px) scale(1);
  }
}
.tri:nth-child(119) {
  border-top: 45px solid #6200ff;
  border-right: 45px solid transparent;
  border-left: 45px solid transparent;
  margin-left: -22.5px;
  margin-top: -22.5px;
...
@keyframes anim119 {
  0% {
    opacity: 1;
    transform: rotate(438deg) translate3d(396px, 701px, 1000px) scale(1);
  }
}
.tri:nth-child(120) {
...
@keyframes anim120 {
  0% {
    opacity: 1;
    transform: rotate(1.5deg) translate3d(554px, 748px, 1000px) scale(1);
  }
}
.tri:nth-child(121) {
  border-top: 30px solid #8cff00;
...
@keyframes anim121 {
  0% {
    opacity: 1;
    transform: rotate(192deg) translate3d(452px, 63px, 1000px) scale(1);
  }
}
.tri:nth-child(122) {
  border-top: 30px solid #006aff;
  border-right: 30px solid transparent;
  border-left: 30px solid transparent;
  margin-left: -15px;
  margin-top: -15px;
...
@keyframes anim122 {
  0% {
    opacity: 1;
    transform: rotate(463.5deg) translate3d(401px, 393px, 1000px) scale(1);
  }
}
.tri:nth-child(123) {
  border-top: 18px solid #b7ff00;
...
@keyframes anim123 {
  0% {
    opacity: 1;
    transform: rotate(64.5deg) translate3d(493px, 349px, 1000px) scale(1);
  }
}
.tri:nth-child(124) {
...
@keyframes anim124 {
  0% {
    opacity: 1;
    transform: rotate(471deg) translate3d(193px, 740px, 1000px) scale(1);
  }
}
.tri:nth-child(125) {
  border-top: 29px solid #ff0051;
...
@keyframes anim125 {
  0% {
    opacity: 1;
    transform: rotate(375deg) translate3d(854px, 441px, 1000px) scale(1);
  }
}
.tri:nth-child(126) {
  border-top: 16px solid #ff00b7;
  border-right: 16px solid transparent;
  border-left: 16px solid transparent;
  margin-left: -8px;
  margin-top: -8px;
...
@keyframes anim126 {
  0% {
    opacity: 1;
    transform: rotate(24deg) translate3d(286px, 229px, 1000px) scale(1);
  }
}
.tri:nth-child(127) {
  border-top: 50px solid #d900ff;
  border-right: 50px solid transparent;
  border-left: 50px solid transparent;
  margin-left: -25px;
  margin-top: -25px;
...
@keyframes anim127 {
  0% {
    opacity: 1;
    transform: rotate(444deg) translate3d(709px, 363px, 1000px) scale(1);
  }
}
.tri:nth-child(128) {
...
@keyframes anim128 {
  0% {
    opacity: 1;
    transform: rotate(433.5deg) translate3d(872px, 289px, 1000px) scale(1);
  }
}
.tri:nth-child(129) {
  border-top: 11px solid #00ffa2;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim129 {
  0% {
    opacity: 1;
    transform: rotate(534deg) translate3d(954px, 625px, 1000px) scale(1);
  }
}
.tri:nth-child(130) {
  border-top: 9px solid #40ff00;
  border-right: 9px solid transparent;
  border-left: 9px solid transparent;
  margin-left: -4.5px;
  margin-top: -4.5px;
...
@keyframes anim130 {
  0% {
    opacity: 1;
    transform: rotate(222deg) translate3d(911px, 318px, 1000px) scale(1);
  }
}
.tri:nth-child(131) {
  border-top: 33px solid #ff0900;
  border-right: 33px solid transparent;
  border-left: 33px solid transparent;
  margin-left: -16.5px;
  margin-top: -16.5px;
...
@keyframes anim131 {
  0% {
    opacity: 1;
    transform: rotate(150deg) translate3d(743px, 25px, 1000px) scale(1);
  }
}
.tri:nth-child(132) {
  border-top: 40px solid #0048ff;
  border-right: 40px solid transparent;
  border-left: 40px solid transparent;
  margin-left: -20px;
  margin-top: -20px;
...
@keyframes anim132 {
  0% {
    opacity: 1;
    transform: rotate(238.5deg) translate3d(365px, 930px, 1000px) scale(1);
  }
}
.tri:nth-child(133) {
...
@keyframes anim133 {
  0% {
    opacity: 1;
    transform: rotate(109.5deg) translate3d(59px, 531px, 1000px) scale(1);
  }
}
.tri:nth-child(134) {
  border-top: 25px solid #ff00f7;
  border-right: 25px solid transparent;
  border-left: 25px solid transparent;
  margin-left: -12.5px;
  margin-top: -12.5px;
...
@keyframes anim134 {
  0% {
    opacity: 1;
    transform: rotate(309deg) translate3d(281px, 420px, 1000px) scale(1);
  }
}
.tri:nth-child(135) {
  border-top: 16px solid #00ffb7;
  border-right: 16px solid transparent;
  border-left: 16px solid transparent;
  margin-left: -8px;
  margin-top: -8px;
...
@keyframes anim135 {
  0% {
    opacity: 1;
    transform: rotate(481.5deg) translate3d(438px, 149px, 1000px) scale(1);
  }
}
.tri:nth-child(136) {
  border-top: 28px solid #ee00ff;
  border-right: 28px solid transparent;
  border-left: 28px solid transparent;
  margin-left: -14px;
  margin-top: -14px;
...
@keyframes anim136 {
  0% {
    opacity: 1;
    transform: rotate(199.5deg) translate3d(71px, 61px, 1000px) scale(1);
  }
}
.tri:nth-child(137) {
  border-top: 39px solid #0080ff;
  border-right: 39px solid transparent;
  border-left: 39px solid transparent;
  margin-left: -19.5px;
  margin-top: -19.5px;
...
@keyframes anim137 {
  0% {
    opacity: 1;
    transform: rotate(486deg) translate3d(789px, 975px, 1000px) scale(1);
  }
}
.tri:nth-child(138) {
...
@keyframes anim138 {
  0% {
    opacity: 1;
    transform: rotate(165deg) translate3d(830px, 399px, 1000px) scale(1);
  }
}
.tri:nth-child(139) {
  border-top: 32px solid #6aff00;
  border-right: 32px solid transparent;
  border-left: 32px solid transparent;
  margin-left: -16px;
  margin-top: -16px;
...
@keyframes anim139 {
  0% {
    opacity: 1;
    transform: rotate(483deg) translate3d(118px, 245px, 1000px) scale(1);
  }
}
.tri:nth-child(140) {
  border-top: 11px solid #ff0073;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim140 {
  0% {
    opacity: 1;
    transform: rotate(117deg) translate3d(350px, 710px, 1000px) scale(1);
  }
}
.tri:nth-child(141) {
  border-top: 38px solid #00ddff;
  border-right: 38px solid transparent;
  border-left: 38px solid transparent;
  margin-left: -19px;
  margin-top: -19px;
...
@keyframes anim141 {
  0% {
    opacity: 1;
    transform: rotate(475.5deg) translate3d(406px, 581px, 1000px) scale(1);
  }
}
.tri:nth-child(142) {
...
@keyframes anim142 {
  0% {
    opacity: 1;
    transform: rotate(301.5deg) translate3d(948px, 52px, 1000px) scale(1);
  }
}
.tri:nth-child(143) {
  border-top: 44px solid #002fff;
  border-right: 44px solid transparent;
  border-left: 44px solid transparent;
  margin-left: -22px;
  margin-top: -22px;
...
@keyframes anim143 {
  0% {
    opacity: 1;
    transform: rotate(247.5deg) translate3d(308px, 192px, 1000px) scale(1);
  }
}
.tri:nth-child(144) {
  border-top: 11px solid #00ff15;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim144 {
  0% {
    opacity: 1;
    transform: rotate(139.5deg) translate3d(748px, 608px, 1000px) scale(1);
  }
}
.tri:nth-child(145) {
...
@keyframes anim145 {
  0% {
    opacity: 1;
    transform: rotate(241.5deg) translate3d(131px, 383px, 1000px) scale(1);
  }
}
.tri:nth-child(146) {
  border-top: 48px solid #6aff00;
  border-right: 48px solid transparent;
  border-left: 48px solid transparent;
  margin-left: -24px;
  margin-top: -24px;
...
@keyframes anim146 {
  0% {
    opacity: 1;
    transform: rotate(87deg) translate3d(744px, 193px, 1000px) scale(1);
  }
}
.tri:nth-child(147) {
...
@keyframes anim147 {
  0% {
    opacity: 1;
    transform: rotate(531deg) translate3d(535px, 330px, 1000px) scale(1);
  }
}
.tri:nth-child(148) {
  border-top: 27px solid #ff2600;
  border-right: 27px solid transparent;
  border-left: 27px solid transparent;
  margin-left: -13.5px;
  margin-top: -13.5px;
...
@keyframes anim148 {
  0% {
    opacity: 1;
    transform: rotate(420deg) translate3d(470px, 797px, 1000px) scale(1);
  }
}
.tri:nth-child(149) {
  border-top: 19px solid #007bff;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim149 {
  0% {
    opacity: 1;
    transform: rotate(352.5deg) translate3d(454px, 59px, 1000px) scale(1);
  }
}
.tri:nth-child(150) {
  border-top: 11px solid #ff4800;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim150 {
  0% {
    opacity: 1;
    transform: rotate(208.5deg) translate3d(805px, 616px, 1000px) scale(1);
  }
}
.tri:nth-child(151) {
  border-top: 37px solid #5100ff;
  border-right: 37px solid transparent;
  border-left: 37px solid transparent;
  margin-left: -18.5px;
  margin-top: -18.5px;
...
@keyframes anim151 {
  0% {
    opacity: 1;
    transform: rotate(258deg) translate3d(763px, 532px, 1000px) scale(1);
  }
}
.tri:nth-child(152) {
...
@keyframes anim152 {
  0% {
    opacity: 1;
    transform: rotate(286.5deg) translate3d(858px, 714px, 1000px) scale(1);
  }
}
.tri:nth-child(153) {
  border-top: 6px solid #00ff84;
  border-right: 6px solid transparent;
  border-left: 6px solid transparent;
  margin-left: -3px;
  margin-top: -3px;
...
@keyframes anim153 {
  0% {
    opacity: 1;
    transform: rotate(298.5deg) translate3d(377px, 362px, 1000px) scale(1);
  }
}
.tri:nth-child(154) {
...
@keyframes anim154 {
  0% {
    opacity: 1;
    transform: rotate(13.5deg) translate3d(160px, 32px, 1000px) scale(1);
  }
}
.tri:nth-child(155) {
  border-top: 32px solid #9100ff;
  border-right: 32px solid transparent;
  border-left: 32px solid transparent;
  margin-left: -16px;
  margin-top: -16px;
...
@keyframes anim155 {
  0% {
    opacity: 1;
    transform: rotate(73.5deg) translate3d(380px, 725px, 1000px) scale(1);
  }
}
.tri:nth-child(156) {
  border-top: 14px solid #cc00ff;
  border-right: 14px solid transparent;
  border-left: 14px solid transparent;
  margin-left: -7px;
  margin-top: -7px;
...
@keyframes anim156 {
  0% {
    opacity: 1;
    transform: rotate(177deg) translate3d(317px, 913px, 1000px) scale(1);
  }
}
.tri:nth-child(157) {
  border-top: 9px solid #ff00d5;
  border-right: 9px solid transparent;
  border-left: 9px solid transparent;
  margin-left: -4.5px;
  margin-top: -4.5px;
...
@keyframes anim157 {
  0% {
    opacity: 1;
    transform: rotate(114deg) translate3d(35px, 433px, 1000px) scale(1);
  }
}
.tri:nth-child(158) {
  border-top: 23px solid #b300ff;
...
@keyframes anim158 {
  0% {
    opacity: 1;
    transform: rotate(333deg) translate3d(121px, 389px, 1000px) scale(1);
  }
}
.tri:nth-child(159) {
  border-top: 24px solid #ffbb00;
  border-right: 24px solid transparent;
  border-left: 24px solid transparent;
  margin-left: -12px;
  margin-top: -12px;
...
@keyframes anim159 {
  0% {
    opacity: 1;
    transform: rotate(51deg) translate3d(22px, 715px, 1000px) scale(1);
  }
}
.tri:nth-child(160) {
...
@keyframes anim160 {
  0% {
    opacity: 1;
    transform: rotate(213deg) translate3d(548px, 163px, 1000px) scale(1);
  }
}
.tri:nth-child(161) {
  border-top: 11px solid #001eff;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim161 {
  0% {
    opacity: 1;
    transform: rotate(136.5deg) translate3d(952px, 711px, 1000px) scale(1);
  }
}
.tri:nth-child(162) {
  border-top: 13px solid #00ff99;
  border-right: 13px solid transparent;
  border-left: 13px solid transparent;
  margin-left: -6.5px;
  margin-top: -6.5px;
...
@keyframes anim162 {
  0% {
    opacity: 1;
    transform: rotate(88.5deg) translate3d(548px, 470px, 1000px) scale(1);
  }
}
.tri:nth-child(163) {
...
@keyframes anim163 {
  0% {
    opacity: 1;
    transform: rotate(517.5deg) translate3d(987px, 693px, 1000px) scale(1);
  }
}
.tri:nth-child(164) {
  border-top: 22px solid #ff4000;
...
@keyframes anim164 {
  0% {
    opacity: 1;
    transform: rotate(475.5deg) translate3d(125px, 961px, 1000px) scale(1);
  }
}
.tri:nth-child(165) {
  border-top: 27px solid #00ff99;
  border-right: 27px solid transparent;
  border-left: 27px solid transparent;
  margin-left: -13.5px;
  margin-top: -13.5px;
...
@keyframes anim165 {
  0% {
    opacity: 1;
    transform: rotate(384deg) translate3d(278px, 523px, 1000px) scale(1);
  }
}
.tri:nth-child(166) {
...
@keyframes anim166 {
  0% {
    opacity: 1;
    transform: rotate(310.5deg) translate3d(247px, 434px, 1000px) scale(1);
  }
}
.tri:nth-child(167) {
  border-top: 19px solid #0055ff;
  border-right: 19px solid transparent;
  border-left: 19px solid transparent;
  margin-left: -9.5px;
  margin-top: -9.5px;
...
@keyframes anim167 {
  0% {
    opacity: 1;
    transform: rotate(511.5deg) translate3d(37px, 970px, 1000px) scale(1);
  }
}
.tri:nth-child(168) {
  border-top: 17px solid #0026ff;
  border-right: 17px solid transparent;
  border-left: 17px solid transparent;
  margin-left: -8.5px;
  margin-top: -8.5px;
...
@keyframes anim168 {
  0% {
    opacity: 1;
    transform: rotate(160.5deg) translate3d(652px, 362px, 1000px) scale(1);
  }
}
.tri:nth-child(169) {
  border-top: 31px solid #4800ff;
...
@keyframes anim169 {
  0% {
    opacity: 1;
    transform: rotate(12deg) translate3d(710px, 713px, 1000px) scale(1);
  }
}
.tri:nth-child(170) {
...
@keyframes anim170 {
  0% {
    opacity: 1;
    transform: rotate(147deg) translate3d(582px, 831px, 1000px) scale(1);
  }
}
.tri:nth-child(171) {
  border-top: 22px solid #b7ff00;
  border-right: 22px solid transparent;
  border-left: 22px solid transparent;
  margin-left: -11px;
  margin-top: -11px;
...
@keyframes anim171 {
  0% {
    opacity: 1;
    transform: rotate(439.5deg) translate3d(850px, 259px, 1000px) scale(1);
  }
}
.tri:nth-child(172) {
...
@keyframes anim172 {
  0% {
    opacity: 1;
    transform: rotate(190.5deg) translate3d(501px, 818px, 1000px) scale(1);
  }
}
.tri:nth-child(173) {
  border-top: 49px solid #84ff00;
  border-right: 49px solid transparent;
  border-left: 49px solid transparent;
  margin-left: -24.5px;
  margin-top: -24.5px;
...
@keyframes anim173 {
  0% {
    opacity: 1;
    transform: rotate(136.5deg) translate3d(747px, 157px, 1000px) scale(1);
  }
}
.tri:nth-child(174) {
  border-top: 14px solid #00ff91;
  border-right: 14px solid transparent;
  border-left: 14px solid transparent;
  margin-left: -7px;
  margin-top: -7px;
...
@keyframes anim174 {
  0% {
    opacity: 1;
    transform: rotate(366deg) translate3d(911px, 847px, 1000px) scale(1);
  }
}
.tri:nth-child(175) {
...
@keyframes anim175 {
  0% {
    opacity: 1;
    transform: rotate(160.5deg) translate3d(310px, 260px, 1000px) scale(1);
  }
}
.tri:nth-child(176) {
  border-top: 6px solid #00ff6f;
  border-right: 6px solid transparent;
  border-left: 6px solid transparent;
  margin-left: -3px;
  margin-top: -3px;
...
@keyframes anim176 {
  0% {
    opacity: 1;
    transform: rotate(271.5deg) translate3d(254px, 142px, 1000px) scale(1);
  }
}
.tri:nth-child(177) {
  border-top: 50px solid #ff1a00;
  border-right: 50px solid transparent;
  border-left: 50px solid transparent;
  margin-left: -25px;
  margin-top: -25px;
...
@keyframes anim177 {
  0% {
    opacity: 1;
    transform: rotate(49.5deg) translate3d(49px, 745px, 1000px) scale(1);
  }
}
.tri:nth-child(178) {
  border-top: 42px solid #ff0077;
  border-right: 42px solid transparent;
  border-left: 42px solid transparent;
  margin-left: -21px;
  margin-top: -21px;
...
@keyframes anim178 {
  0% {
    opacity: 1;
    transform: rotate(321deg) translate3d(51px, 396px, 1000px) scale(1);
  }
}
.tri:nth-child(179) {
  border-top: 39px solid #ffd000;
  border-right: 39px solid transparent;
  border-left: 39px solid transparent;
  margin-left: -19.5px;
  margin-top: -19.5px;
...
@keyframes anim179 {
  0% {
    opacity: 1;
    transform: rotate(520.5deg) translate3d(211px, 124px, 1000px) scale(1);
  }
}
.tri:nth-child(180) {
  border-top: 46px solid #00d9ff;
  border-right: 46px solid transparent;
  border-left: 46px solid transparent;
  margin-left: -23px;
  margin-top: -23px;
...
@keyframes anim180 {
  0% {
    opacity: 1;
    transform: rotate(156deg) translate3d(877px, 870px, 1000px) scale(1);
  }
}
.tri:nth-child(181) {
  border-top: 12px solid #00ff44;
  border-right: 12px solid transparent;
  border-left: 12px solid transparent;
  margin-left: -6px;
  margin-top: -6px;
...
@keyframes anim181 {
  0% {
    opacity: 1;
    transform: rotate(343.5deg) translate3d(763px, 392px, 1000px) scale(1);
  }
}
.tri:nth-child(182) {
  border-top: 9px solid #6fff00;
  border-right: 9px solid transparent;
  border-left: 9px solid transparent;
  margin-left: -4.5px;
  margin-top: -4.5px;
...
@keyframes anim182 {
  0% {
    opacity: 1;
    transform: rotate(423deg) translate3d(747px, 294px, 1000px) scale(1);
  }
}
.tri:nth-child(183) {
  border-top: 18px solid #ff00ee;
  border-right: 18px solid transparent;
  border-left: 18px solid transparent;
  margin-left: -9px;
  margin-top: -9px;
...
@keyframes anim183 {
  0% {
    opacity: 1;
    transform: rotate(402deg) translate3d(975px, 245px, 1000px) scale(1);
  }
}
.tri:nth-child(184) {
  border-top: 43px solid #fff700;
  border-right: 43px solid transparent;
  border-left: 43px solid transparent;
  margin-left: -21.5px;
  margin-top: -21.5px;
...
@keyframes anim184 {
  0% {
    opacity: 1;
    transform: rotate(36deg) translate3d(139px, 972px, 1000px) scale(1);
  }
}
.tri:nth-child(185) {
  border-top: 18px solid #ff00d5;
  border-right: 18px solid transparent;
  border-left: 18px solid transparent;
  margin-left: -9px;
  margin-top: -9px;
...
@keyframes anim185 {
  0% {
    opacity: 1;
    transform: rotate(357deg) translate3d(791px, 233px, 1000px) scale(1);
  }
}
.tri:nth-child(186) {
  border-top: 6px solid #a2ff00;
  border-right: 6px solid transparent;
  border-left: 6px solid transparent;
  margin-left: -3px;
  margin-top: -3px;
...
@keyframes anim186 {
  0% {
    opacity: 1;
    transform: rotate(114deg) translate3d(805px, 872px, 1000px) scale(1);
  }
}
.tri:nth-child(187) {
  border-top: 41px solid #00aeff;
  border-right: 41px solid transparent;
  border-left: 41px solid transparent;
  margin-left: -20.5px;
  margin-top: -20.5px;
...
@keyframes anim187 {
  0% {
    opacity: 1;
    transform: rotate(22.5deg) translate3d(642px, 311px, 1000px) scale(1);
  }
}
.tri:nth-child(188) {
...
@keyframes anim188 {
  0% {
    opacity: 1;
    transform: rotate(204deg) translate3d(960px, 662px, 1000px) scale(1);
  }
}
.tri:nth-child(189) {
  border-top: 27px solid #008cff;
  border-right: 27px solid transparent;
  border-left: 27px solid transparent;
  margin-left: -13.5px;
  margin-top: -13.5px;
...
@keyframes anim189 {
  0% {
    opacity: 1;
    transform: rotate(52.5deg) translate3d(719px, 563px, 1000px) scale(1);
  }
}
.tri:nth-child(190) {
  border-top: 31px solid #00f7ff;
  border-right: 31px solid transparent;
  border-left: 31px solid transparent;
  margin-left: -15.5px;
  margin-top: -15.5px;
  -webkit-filter: grayscale(1);
  filter: grayscale(1);
  transform: rotate(200deg) translate3d(0, 0, -1500px) scale(0);
...
@keyframes anim190 {
  0% {
    opacity: 1;
    transform: rotate(300deg) translate3d(681px, 386px, 1000px) scale(1);
  }
}
.tri:nth-child(191) {
  border-top: 11px solid #0400ff;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim191 {
  0% {
    opacity: 1;
    transform: rotate(183deg) translate3d(511px, 786px, 1000px) scale(1);
  }
}
.tri:nth-child(192) {
...
@keyframes anim192 {
  0% {
    opacity: 1;
    transform: rotate(484.5deg) translate3d(785px, 991px, 1000px) scale(1);
  }
}
.tri:nth-child(193) {
  border-top: 50px solid #ff0011;
  border-right: 50px solid transparent;
  border-left: 50px solid transparent;
  margin-left: -25px;
  margin-top: -25px;
...
@keyframes anim193 {
  0% {
    opacity: 1;
    transform: rotate(322.5deg) translate3d(227px, 474px, 1000px) scale(1);
  }
}
.tri:nth-child(194) {
  border-top: 3px solid #d900ff;
  border-right: 3px solid transparent;
  border-left: 3px solid transparent;
  margin-left: -1.5px;
  margin-top: -1.5px;
...
@keyframes anim194 {
  0% {
    opacity: 1;
    transform: rotate(55.5deg) translate3d(329px, 32px, 1000px) scale(1);
  }
}
.tri:nth-child(195) {
  border-top: 50px solid #00ddff;
  border-right: 50px solid transparent;
  border-left: 50px solid transparent;
  margin-left: -25px;
  margin-top: -25px;
...
@keyframes anim195 {
  0% {
    opacity: 1;
    transform: rotate(190.5deg) translate3d(139px, 194px, 1000px) scale(1);
  }
}
.tri:nth-child(196) {
...
@keyframes anim196 {
  0% {
    opacity: 1;
    transform: rotate(201deg) translate3d(590px, 397px, 1000px) scale(1);
  }
}
.tri:nth-child(197) {
  border-top: 45px solid #ff0044;
  border-right: 45px solid transparent;
  border-left: 45px solid transparent;
  margin-left: -22.5px;
  margin-top: -22.5px;
...
@keyframes anim197 {
  0% {
    opacity: 1;
    transform: rotate(132deg) translate3d(889px, 30px, 1000px) scale(1);
  }
}
.tri:nth-child(198) {
  border-top: 11px solid #00eeff;
  border-right: 11px solid transparent;
  border-left: 11px solid transparent;
  margin-left: -5.5px;
  margin-top: -5.5px;
...
@keyframes anim198 {
  0% {
    opacity: 1;
    transform: rotate(480deg) translate3d(597px, 654px, 1000px) scale(1);
  }
}
.tri:nth-child(199) {
...
@keyframes anim199 {
  0% {
    opacity: 1;
    transform: rotate(369deg) translate3d(668px, 372px, 1000px) scale(1);
  }
}
.tri:nth-child(200) {
  border-top: 20px solid #5e00ff;
  border-right: 20px solid transparent;
  border-left: 20px solid transparent;
  margin-left: -10px;
  margin-top: -10px;
...
@keyframes anim200 {
  0% {
    opacity: 1;
    transform: rotate(486deg) translate3d(786px, 472px, 1000px) scale(1);
  }
}
